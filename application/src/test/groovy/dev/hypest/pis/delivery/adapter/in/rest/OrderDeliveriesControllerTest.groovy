...
class OrderDeliveriesControllerTest extends BaseTest {
    ...
    def "when get is performed against /offer"() {
        ...
        def offer = new OrderDeliveryOfferResponse(UUID.randomUUID(), UUID.randomUUID(), null, null, BigDecimal.ZERO, new OrderDeliveryOfferResponse.DeliveryDetails("address"))
